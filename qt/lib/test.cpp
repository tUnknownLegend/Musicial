...
class mockMessageGroup {
 public:
    ...
    mockMessageGroup(const std::string &text, uint64_t ownerID,
                     ...
                     Messages(text, ownerID, platform, playlists, songs, toPlatform) {
...
TEST(mMessageGroup, MockmMessageGroupAll) {
    ...
    playlists.emplace_back(
            sharedLib::URL("https://open.spotify.com/playlist/1hBbNxTjcitTZfu51dB7RB"), platform);
    std::vector<sharedLib::Song> songs;
    songs.emplace_back(
            sharedLib::URL("https://open.spotify.com/track/0ZLhqWBAhobSU4bTvKdM2K?si=e8a36ebb078f4dea"),
                       platform);
...
TEST(checkURLs, allRight) {
    std::vector<sharedLib::Playlist> playlists;
    playlists.emplace_back(
            sharedLib::URL("https://open.spotify.com/playlist/1hBbNxTjcitTZfu51dB7RB"),
                           sharedLib::Spotify);
    playlists.emplace_back(
            sharedLib::URL("https://www.youtube.com/playlist?list=PLcidtVPGDsUWcrT65QjefzB8syuGpgDoN"),
                           sharedLib::YouTube);
    std::vector<sharedLib::Song> songs;
    songs.emplace_back(
            sharedLib::URL("https://open.spotify.com/track/0ZLhqWBAhobSU4bTvKdM2K?si=e8a36ebb078f4dea"),
                       sharedLib::Spotify),
            songs.emplace_back(
                    sharedLib::URL("https://www.youtube.com/watch?v=dcG8c_KxeJ4a"), sharedLib::YouTube);
...
TEST(checkURLs, allFalse) {
    std::vector<sharedLib::Playlist> playlists;
    playlists.emplace_back(
            sharedLib::URL("https://open.spoify.com/playlist/1hBbNxTjcitTZfu51dB7RB"),
                           sharedLib::Spotify);
    playlists.emplace_back(
            sharedLib::URL("https://www.youtub.com/playlist?list=PLcidtVPGDsUWcrT65QjefzB8syuGpgDoN"),
                           sharedLib::YouTube);
    std::vector<sharedLib::Song> songs;
    songs.emplace_back(
            sharedLib::URL("https://open.spoify.co/track/0ZLhqWBAhobSU4bTvKdM2K?si=e8a36ebb078f4dea"),
                       sharedLib::Spotify),
...
TEST(checkURLs, semiFalse) {
    ...
    playlists.emplace_back(
            sharedLib::URL("https://open.spotify.com/playlist/1hBbNxTjcitTZfu51dB7RB"),
                           sharedLib::Spotify);
    playlists.emplace_back(
            sharedLib::URL("https://www.youtuba.com/playlist?list=PLcidtVPGDsUWcrT65QjefzB8syuGpgDoN"),
                           sharedLib::YouTube);
    std::vector<sharedLib::Song> songs;
    songs.emplace_back(
            sharedLib::URL("https://open.spotify.com/track/0ZLhqWBAhobSU4bTvKdM2K?si=e8a36ebb078f4dea"),
